...
class DiffusionDVAEModel(nn.Module):
...
def do_training(model, optimizer, accelerator, train_dl, device, demo_callback, global_args, max_epochs=10000000):
    ...
    for epoch in range(max_epochs):
        ...
        demo_callback.on_train_epoch_end(model, model)
...
def main():
    ...
    diffusion_model, optimizer, train_dl, demo_dl = accelerator.prepare(diffusion_model, optimizer, train_dl, demo_dl)
    ...
    print("Calling do_training...")

    do_training(diffusion_model, optimizer, accelerator, train_dl, device, demo_callback, args, max_epochs=10000000)
